...
public class DBAdapter {
    ...
    public long insertRow(Integer chapter, Integer scene, Integer path, Double credit, Double debit,
        ...
        initialValues.put(KEY_SCENE, scene);
    ...
    */
    ...
    public boolean updateRow(long rowId, Integer chapter, Integer scene, Integer path, double credit,
        ...
        newValues.put(KEY_CHAPTER, chapter);
        newValues.put(KEY_SCENE, scene);
        newValues.put(KEY_PATH, path);
        newValues.put(KEY_CREDIT, credit);
...
// Testing, uncomment other stuff
    ...
    public Cursor queryStuff(String username, String password) {
        ...
        return db.query(DATABASE_TABLE,
                columns,
                KEY_CHAPTER + " = \'" + username + "\' AND " + KEY_SCENE + " = \'" + password + "\'"
                ,
                null, null, null, null);
